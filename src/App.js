      ...
      <header className="relative max-w-6xl mx-auto rounded-3xl p-6 bg-gradient-to-r from-[#0b1220]/70 via-[#111827]/60 to-[#06102a]/70 ring-1 ring-white/5 shadow-2xl backdrop-blur z-10">
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="ml-auto flex gap-3">
            ...
            <a href="https://kavinrajr007.github.io/kavinraj-portfolio/resume.pdf" download target="_blank" target="_blank" className="inline-flex items-center gap-2 px-4 py-2 border border-white/10 text-white rounded-lg hover:bg-white/5">Download Resume</a>
          </div>
        </div>
      </header>
